 ...
 */
public class AraneaJsfResponseWrapper extends HttpServletResponseWrapper {
	private static final Logger log = Logger.getLogger(AraneaJsfResponseWrapper.class);
...
//		if (getResponse() instanceof AraneaJsfResponseWrapper)
//			return ((AraneaJsfResponseWrapper)getResponse()).getOriginalResponse();
