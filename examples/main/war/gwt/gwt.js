...
function ModuleControlBlock(metaElem, rawName) {
  ...
  if (i != -1) {
    var j = rawName.substring(0, i).lastIndexOf("=");
    if (j != -1) {
      container = rawName.substring(0, j);
      parts[0] = rawName.substring(j+1, i) + '/';
    } else {
...
ModuleControlBlock.prototype.getContainer = function() {
