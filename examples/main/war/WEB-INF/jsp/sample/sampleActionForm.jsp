							...
							<ui:formElement id="quantity">
								...
								<script type="text/javascript">
									Event.observe(formId + '.quantity', 'change', function(event) {
										araneaPage().action(event.target, 'quantityChange', widgetId, event.target.value, false, callback);
									});
								</script>
							</ui:formElement>
						</ui:cell>
							...
							<ui:formElement id="vat">
								...
								<script type="text/javascript">
									Event.observe(formId + '.vat', 'change', function(event) {
										araneaPage().action_6(document.system_form_0, 'vatChange', widgetId, event.target.value, false, callback);
									});
								</script>
							</ui:formElement>
						</ui:cell>
