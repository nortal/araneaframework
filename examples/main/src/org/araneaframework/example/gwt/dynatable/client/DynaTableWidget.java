 ...
 * the License.
 */
package org.araneaframework.example.gwt.dynatable.client;

import org.araneaframework.example.gwt.dynatable.client.DynaTableDataProvider.RowDataAcceptor;
...
public class DynaTableWidget extends Composite {
  ...
  private class RowDataAcceptorImpl implements RowDataAcceptor {
    public void accept(int startRow, String[][] data) {
      ...
      //FIXME assert (data.length <= destRowCount) : "Too many rows";
      ...
      for (; srcRowIndex < srcRowCount; ++srcRowIndex, ++destRowIndex) {
        ...
        //FIXME assert (srcRowData.length == destColCount) : " Column count mismatch";
