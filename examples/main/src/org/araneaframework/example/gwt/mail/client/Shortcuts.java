...
public class Shortcuts extends Composite {
  ...
  public Shortcuts() {
    ...
    stackPanel.add(new Mailboxes(), createHeaderHTML(Mail.URL_PREFIX + "mailgroup.gif", "Mail"), true);
    stackPanel.add(new Tasks(), createHeaderHTML(Mail.URL_PREFIX + "tasksgroup.gif", "Tasks"), true);
    stackPanel.add(new Contacts(), createHeaderHTML(Mail.URL_PREFIX + "contactsgroup.gif", "Contacts"), true);
