  ...
  protected void action(Path path, InputData input, OutputData output) throws Exception {
    ...
    if (ExceptionUtils.getRootCause(this.exception) != null) {
      ...
      out.write("<pre style=\'font-size: 10pt\'>"
          + ExceptionUtils.getFullStackTrace(ExceptionUtils.getRootCause(this.exception)) + "</pre>");
    }
    out.write("<b>Stack trace:</b><br/>");
    out.write("<pre style=\'font-size: 10pt\'>" + ExceptionUtils.getFullStackTrace(this.exception) + "</pre>");
    out.write("</body></html>");
    out.write("</div></div><!-- end content --></div></div><div class=\"clear1\">&nbsp;</div></div></body></html>");
  }
}
