...
public class WizardFooterTag extends BaseTag {
  ...
  protected int doStartTag(Writer out) throws Exception {
    ...
    writeEventButtonTag(WIZARD_GOTO_EVENT_ID, Integer.toString(index - 1), index == 0, WIZARD_GOTO_PREV_LABEL_ID);
    writeEventButtonTag(WIZARD_GOTO_EVENT_ID, Integer.toString(index + 1), index == count - 1,
        WIZARD_GOTO_NEXT_LABEL_ID);
  ...
  protected void writeEventButtonTag(String eventId, String eventParam, boolean disabled, String labelId)
      throws JspException {
