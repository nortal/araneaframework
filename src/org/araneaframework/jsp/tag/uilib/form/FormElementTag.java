...
/**
 * Specifies form element context for inner tags. Form element view model, id and value are made accessible to inner
 * tags as EL variables.
 * 
 ...
 *  name = "formElement"
 *  body-content = "JSP"
 *  description = "UiLib form element tag. <br/>Makes available following variables:<ul><li><i>formElement</i> - UiLib form element view model.</li><li><i>formElementId</i> - UiLib form element id.</li><li><i>formElementValue</i> - UiLib form element value.</li></ul>"
 */
...
public class FormElementTag extends BaseTag {
  ...
  public int doStartTag(Writer out) throws Exception {
    ...
    // Get form element
    this.formElementViewModel = (FormElement.ViewModel) JspWidgetUtil.traverseToSubWidget(form, this.id)._getViewable()
        .getViewModel();
