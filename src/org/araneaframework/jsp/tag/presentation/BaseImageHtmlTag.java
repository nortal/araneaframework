...
public abstract class BaseImageHtmlTag extends BaseImageTag {
  ...
  protected int doStartTag(Writer out) throws Exception {
    ...
    writeImageLocal(out, this.src, this.width, this.height, this.alt, getStyleClass(), this.title);
  ...
  public void writeImageLocal(Writer out, String src, String width, String height, String alt, String styleClass,
   ...
   */
  public static void writeImage(Writer out, String src, String width, String height, String styleClass, String title)
      throws IOException {
   ...
   * Static method to write out image with given properties.
   */
  public static void writeImage(Writer out, String src, String width, String height, String alt, String styleClass,
      String title) throws IOException {
