...
/**
 * A class that holds information about the tag and the attributes of the tag that will be used to render the form
 * element. It is mainly used {@link AutomaticFormElementUtil}
 * 
...
public class FormElementViewSelector implements Serializable {
  ...
  /**
   * The key that can be used to put or get a selector (this class) from the properties list of a view model belonging
   * to a form element.
   * 
  ...
  /**
   * Default URI of the tag library from where the specified <code>tag</code> will be searched.
   */
  ...
  /**
   * The attributes for the tag are key-value pairs where key is a <code>String</code> (the name of the attribute) and
  ...
  /**
   * Creates a view selector for a form element (the latter is specified through {@link AutomaticFormElementUtil}). This
   * object will only carry information about which tag (with attributes) to use.
   * <p>
   * The attributes for the tag are key-value pairs where key is a <code>String</code> (the name of the attribute) and
   * value is any object (the value for the attribute).
   * <p>
   * The attribute names must qualify to appropriate setter of class {@link AutomaticTagFormElementTag} as:
   * 
   * <pre>
   * <code>set[attributeName]([AttributeValueType] attributeValue)</code>
   * </pre>
   * <p>
   * <b>This constructor expects that the URI of the tag library is the same as for Aranea tag library!</b>
   * 
  ...
  /**
   * Creates a view selector for a form element (the latter is specified through {@link AutomaticFormElementUtil}). This
   * object will only carry information about which tag (with its URI and attributes) to use.
   * <p>
   ...
   * value is any object (the value for the attribute).
   * <p>
   * The attribute names must qualifify to appropriate setter of class {@link AutomaticTagFormElementTag} as:
   * 
   * <pre>
   * <code>set[attributeName]([AttributeValueType] attributeValue)</code>
   * </pre>
  ...
  /**
   * Provides access to the attributes of the tag. The attributes are key-value pairs where key is a <code>String</code>
   * (the name of the attribute) and value is any object (the value for the attribute).
   * <p>
   * The attribute names must qualify to appropriate setter of class {@link AutomaticTagFormElementTag} as:
   * <pre>
   * <code>set[attributeName]([AttributeValueType] attributeValue)</code>
