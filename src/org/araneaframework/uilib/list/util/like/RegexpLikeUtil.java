...
public class RegexpLikeUtil {
  ...
  /**
   * Checks if the <code>string</code> matches with the <code>mask</code> or not.
   * 
   * @param string the comparable string.
   * @param customMask the mask which the <code>string</code> is compared to.
   * @param ignoreCase whether to compare the <code>string</code> and <code>mask</code> case insensitive.
   * @param config Like configuration.
   * @return <code>true</code> if the <code>string</code> matches with the <code>mask</code>.
   */
  ...
  /**
   * Checks whether given <code>string</code> starts with given <code>customMask</code> using regular expression.
   * 
   ...
   * @return <code>true</code>, if given <code>string</code> starts with given <code>customMask</code>
   * @since 1.1.3
   */
  ...
  /**
   * Checks whether given <code>string</code> ends with given <code>customMask</code> using regular expression.
   * 
   * @param string The string to check.
   * @param customMask The mask that must match.
   * @param ignoreCase Specifies the case sensitivity of the match.
   * @param config Configuration of the expression.
   * @return <code>true</code>, if given <code>string</code> ends with given <code>customMask</code>
   * @since 1.1.3
   */
