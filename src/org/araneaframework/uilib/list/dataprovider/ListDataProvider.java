...
public interface ListDataProvider<T> extends Serializable {
   ...
   * </p>
   * <p>
   * The same {@link Map} instance can be modified at the back-end using the method {@link ListQuery#getFilterInfo()}
   * before the actual {@link Expression} is constructed.
   * 
   * @param filterInfo the filter of the list.
   * @since 1.1
   */
  void setFilterInfo(Map<String, Object> filterInfo);
   ...
   * </p>
   * <p>
   * The same {@link OrderInfo} instance can be modified at the back-end using the method
   * {@link ListQuery#getOrderInfo()} before the actual {@link ComparatorExpression} is constructed.
   * 
   ...
   */
  ListItemsData<T> getItemRange(Long start, Long count) throws Exception;
   ...
   */
  T getItem(Long index) throws Exception;
   ...
   */
  ListItemsData<T> getAllItems() throws Exception;

  /** @since 1.1 */
  void addDataUpdateListener(DataUpdateListener listener);

  /** @since 1.1 */
  void removeDataUpdateListener(DataUpdateListener listener);
