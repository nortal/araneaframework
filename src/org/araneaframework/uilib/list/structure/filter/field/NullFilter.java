...
public abstract class NullFilter extends BaseFieldFilter {
  ...
  public static NullFilter getIdNullInstance(FilterContext ctx, String fieldId, String valueId, Object conditionValue) {
  ...
  public static NullFilter getIsNullConstantInstance(FilterContext ctx, String fieldId) {
    IsNullConstant filter = new IsNullConstant();
    filter.setFieldId(fieldId);
    return filter;
  }

  public static NullFilter getNotNullInstance(FilterContext ctx, String fieldId, String valueId, Object conditionValue) {
  ...
  public static NullFilter getNotNullConstantInstance(FilterContext ctx, String fieldId) {
