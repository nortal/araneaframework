...
/**
 * A filter for StartsWith expressions. Handles also form element adding. Similar to <code>LikeFilter</code>, but has a
...
public class StartsWithFilter extends BaseFieldFilter {
  ...
  public static StartsWithFilter getInstance(FilterContext ctx, String fieldId, String valueId) {
  ...
  public static StartsWithFilter getConstantInstance(FilterContext ctx, String fieldId, String valueId, Object value) {
  ...
  public Expression buildExpression(Map<String, Object> filterInfo) {
    ...
    return ExpressionUtil.startsWith(buildVariableExpression(), buildValueExpression(filterInfo), isIgnoreCase(),
        getConfiguration());
  }
