...
public abstract class SqlFunctionFilter extends BaseFilter {
  ...
  public static SqlFunctionFilter getFieldEqualInstance(FilterContext ctx, String fieldId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initField(createEqual(), ctx, fieldId, functionName, functionParams);
  }

  public static SqlFunctionFilter getFieldGreaterThanInstance(FilterContext ctx, String fieldId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initField(createGreaterThan(ctx), ctx, fieldId, functionName, functionParams);
  }

  public static SqlFunctionFilter getFieldLowerThanInstance(FilterContext ctx, String fieldId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initField(createLowerThan(ctx), ctx, fieldId, functionName, functionParams);
  }

  public static SqlFunctionFilter getValueEqualInstance(FilterContext ctx, String valueId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initValue(createEqual(), ctx, valueId, functionName, functionParams);
  }

  public static SqlFunctionFilter getValueGreaterThanInstance(FilterContext ctx, String valueId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initValue(createGreaterThan(ctx), ctx, valueId, functionName, functionParams);
  }

  public static SqlFunctionFilter getValueLowerThanInstance(FilterContext ctx, String valueId, String functionName,
      ExpressionBuilder[] functionParams) {
    return initValue(createLowerThan(ctx), ctx, valueId, functionName, functionParams);
  }

  public static SqlFunctionFilter getConstantEqualInstance(FilterContext ctx, String valueId, Object value,
  ...
  public static SqlFunctionFilter getConstantGreaterThanInstance(FilterContext ctx, String valueId, Object value,
      String functionName, ExpressionBuilder[] functionParams) {
    return initConstant(createGreaterThan(ctx), ctx, valueId, value, functionName, functionParams);
  }

  public static SqlFunctionFilter getConstantLowerThanInstance(FilterContext ctx, String valueId, Object value,
      String functionName, ExpressionBuilder[] functionParams) {
  ...
  private static SqlFunctionFilter createGreaterThan(FilterContext ctx) {
    return ctx.isStrict() ? new GreaterThan() : new GreaterThanOrEquals();
  }

  private static SqlFunctionFilter createLowerThan(FilterContext ctx) {
    return ctx.isStrict() ? new LowerThan() : new LowerThanOrEquals();
  }

  private static SqlFunctionFilter initField(SqlFunctionFilter filter, FilterContext ctx, String fieldId,
      String functionName, ExpressionBuilder[] functionParams) {
    filter.setOperand(new Field(fieldId));
    return init(filter, ctx, fieldId, functionName, functionParams);
  }

  private static SqlFunctionFilter initValue(SqlFunctionFilter filter, FilterContext ctx, String valueId,
      String functionName, ExpressionBuilder[] functionParams) {
    filter.setOperand(new Value(valueId));
    return init(filter, ctx, valueId, functionName, functionParams);
  }

  private static SqlFunctionFilter initConstant(SqlFunctionFilter filter, FilterContext ctx, String valueId,
      Object value, String functionName, ExpressionBuilder[] functionParams) {
    filter.setOperand(new Constant(valueId, value));
    return init(filter, ctx, valueId, functionName, functionParams);
  }

  private static SqlFunctionFilter init(SqlFunctionFilter filter, FilterContext ctx, String fieldId,
      String functionName, ExpressionBuilder[] functionParams) {
  ...
  public static void addToForm(FilterContext ctx, String id, GenericFormElement element) {
  ...
  static class Procedure implements ExpressionBuilder {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.sqlFunction(this.name, new LaxyExpressionIterator(Arrays.asList(this.params).iterator(), data));
    }
  }
  ...
  public static class Equal extends SqlFunctionFilter {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.eq(getOperand().buildExpression(data), getProcedure().buildExpression(data),
          getComparator());
    }
  }
  ...
  public static class GreaterThan extends SqlFunctionFilter {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.gt(getOperand().buildExpression(data), getProcedure().buildExpression(data),
          getComparator());
    }
  }
  ...
  public static class LowerThan extends SqlFunctionFilter {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.lt(getOperand().buildExpression(data), getProcedure().buildExpression(data),
          getComparator());
    }
  }
  ...
  public static class GreaterThanOrEquals extends SqlFunctionFilter {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.ge(getOperand().buildExpression(data), getProcedure().buildExpression(data),
          getComparator());
    }
  }
  ...
  public static class LowerThanOrEquals extends SqlFunctionFilter {
    ...
    public Expression buildExpression(Map<String, Object> data) {
      return ExpressionUtil.le(getOperand().buildExpression(data), getProcedure().buildExpression(data),
          getComparator());
    }
  }
}
