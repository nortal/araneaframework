...
/**
 * Standard list filter helper. This class is used to add <b>filters</b> and their <b>form elements</b> to the
 * {@link ListWidget}.
 * <p>
 * THe following filters can be added to the list: {@link EqualFilter}, {@link GreaterThanFilter},
 * {@link LowerThanFilter}, {@link LikeFilter}, {@link NullFilter}, {@link RangeFilter}, {@link RangeInRangeFilter},
 * {@link SqlFunctionFilter}.
 * </p>
 * <p>
 * There are many methods for adding each filter and their form elements. Note that some methods start with the <b>_</b>
 * sign. These add filters without adding form elements to them. Use this only if its inevitable. The default behaivor
 * is to add the filter and its form elements at once to enable filter specific form elements (e.g {@link LikeFilter}
 * uses {@link TextControl} ignoring the field type defined by the list) and avoid many mistakes.
 * </p>
 * <p>
 * Also many filters can be added as constant filters. This means they are just part of the query but do not depend on
 * the user. For example one would like to add constant filter to get only clients from one region without showing this
 * filter to the user or letting it to be modified.
 * </p>
 * <p>
 * In other cases, <b>filters are added with form elements</b> no matter if one pass it within the method arguments or
 * no. For each form element (e.g 2 in case of range filter and 1 in case of like filter) one can pass a form element,
 * just a control or none of these. Passing a control means that the form element is automatically created using the
 * other information available for this filter's field - <b>label</b> and <b>type</b>. Not passing the control either
 * just means that the <b>control</b> is automatically created according the the field type (using
 * {@link FormUtil#createControl(Class)})). However if you like to define label or type for a form element, you can
 * predefine them using {@link #addCustomLabel(String, String)} and {@link #addFieldType(String, Class)} methods. As you
 * could expect, the <b>mandatory</b> is set to <code>false</code> and the <b>initial value</b> is set to null by
 * default.
 * </p>
 * <p>
 * There is one more aspect for all filter adding methods. For each method, one can define <b>valueId</b>. The term
 * <b>value</b> is used here to mark the blank in the filter (basically the form element). By default the <b>fieldId</b>
 * is also used as the valueId. So it's unneccesary to pass a valueId unless one would like to add more than one filter
 * for one field. In the case of range filter, there are already two values used for one filter and therefore original
 * fieldId is suffixed to distinguish the two values - low and high. However for more than two range filter for one
 * field, custom value ids must be used as well.
 * 
...
public class FilterHelper extends BaseFilterHelper {
  ...
  public FilterHelper _eq(String fieldId, String valueId) {
    this.list.addFilter(EqualFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper eqConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(EqualFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _gt(String fieldId, String valueId) {
    this.list.addFilter(GreaterThanFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper gtConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(GreaterThanFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _lt(String fieldId, String valueId) {
    this.list.addFilter(LowerThanFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper ltConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(LowerThanFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _like(String fieldId, String valueId) {
    this.list.addFilter(LikeFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper likeConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(LikeFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _startsWith(String fieldId, String valueId) {
    this.list.addFilter(StartsWithFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper startsWithConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(StartsWithFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _endsWith(String fieldId, String valueId) {
    this.list.addFilter(EndsWithFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public FilterHelper endsWithConst(String fieldId, String valueId, Object value) {
    this.list.addFilter(EndsWithFilter.getConstantInstance(this, fieldId, valueId, value));
    return this;
  }
  ...
  public FilterHelper _isNull(String fieldId, String valueId, Object conditionValue) {
    this.list.addFilter(NullFilter.getIdNullInstance(this, fieldId, valueId, conditionValue));
    return this;
  }
  ...
  public FilterHelper isNullConst(String fieldId) {
    this.list.addFilter(NullFilter.getIsNullConstantInstance(this, fieldId));
    return this;
  }
  ...
  public FilterHelper _notNull(String fieldId, String valueId, Object conditionValue) {
    this.list.addFilter(NullFilter.getNotNullInstance(this, fieldId, valueId, conditionValue));
    return this;
  }
  ...
  public FilterHelper notNullConst(String fieldId) {
    this.list.addFilter(NullFilter.getNotNullConstantInstance(this, fieldId));
    return this;
  }
  ...
  public FilterHelper _range(String fieldId, String lowValueId, String highValueId) {
    this.list.addFilter(RangeFilter.getInstance(this, fieldId, lowValueId, highValueId));
    return this;
  }
  ...
  public FilterHelper fieldRangeInValueRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId) {
  ...
  public FilterHelper fieldRangeInValueRange(String lowFieldId, String highFieldId, Control<?> lowControl,
      Control<?> highControl) {
    return fieldRangeInValueRange(lowFieldId, highFieldId, lowFieldId, highFieldId, lowControl, highControl);
  }

  public FilterHelper fieldRangeInValueRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId, Control<?> lowControl, Control<?> highControl) {
    _fieldRangeInValueRange(lowFieldId, highFieldId, lowValueId, highValueId);
    RangeInRangeFilter.addToForm(this, lowValueId, highValueId, lowControl, highControl);
    return this;
  }

  public FilterHelper fieldRangeInValueRange(String lowFieldId, String highFieldId, FormElement<?, ?> lowElement,
      FormElement<?, ?> highElement) {
    return fieldRangeInValueRange(lowFieldId, highFieldId, lowFieldId, highFieldId, lowElement, highElement);
  }

  public FilterHelper fieldRangeInValueRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId, FormElement<?, ?> lowElement, FormElement<?, ?> highElement) {
    _fieldRangeInValueRange(lowFieldId, highFieldId, lowValueId, highValueId);
  ...
  public FilterHelper _fieldRangeInValueRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId) {
    this.list.addFilter(RangeInRangeFilter.getFieldRangeInValueRangeInstance(this, lowFieldId, highFieldId, lowValueId,
        highValueId));
    return this;
  }
  ...
  public FilterHelper valueRangeInFieldRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId) {
  ...
  public FilterHelper valueRangeInFieldRange(String lowFieldId, String highFieldId, Control<?> lowControl,
      Control<?> highControl) {
  ...
  public FilterHelper valueRangeInFieldRange(String lowFieldId, String highFieldId, FormElement<?, ?> lowElement,
      FormElement<?, ?> highElement) {
  ...
  public FilterHelper _valueRangeInFieldRange(String lowFieldId, String highFieldId, String lowValueId,
      String highValueId) {
    this.list.addFilter(RangeInRangeFilter.getValueRangeInFieldRangeInstance(this, lowFieldId, highFieldId, lowValueId,
        highValueId));
    return this;
  }
  ...
  public FilterHelper overlapRange(String lowFieldId, String highFieldId, String lowValueId, String highValueId,
      Control<?> lowControl, Control<?> highControl) {
    _overlapRange(lowFieldId, highFieldId, lowValueId, highFieldId);
    RangeInRangeFilter.addToForm(this, lowValueId, highValueId, lowControl, highControl);
    return this;
  }

  public FilterHelper overlapRange(String lowFieldId, String highFieldId, FormElement<?, ?> lowElement,
      FormElement<?, ?> highElement) {
    return overlapRange(lowFieldId, highFieldId, lowFieldId, highFieldId, lowElement, highElement);
  }

  public FilterHelper overlapRange(String lowFieldId, String highFieldId, String lowValueId, String highValueId,
      FormElement<?, ?> lowElement, FormElement<?, ?> highElement) {
    _overlapRange(lowFieldId, highFieldId, lowValueId, highFieldId);
    RangeInRangeFilter.addToForm(this, lowValueId, highValueId, lowElement, highElement);
    return this;
  }
  ...
  public FilterHelper _overlapRange(String lowFieldId, String highFieldId, String lowValueId, String highValueId) {
    this.list.addFilter(RangeInRangeFilter.getOverlapInstance(this, lowFieldId, highFieldId, lowValueId, highValueId));
    return this;
  }
  ...
  public FilterHelper _in(String fieldId, String valueId) {
    this.list.addFilter(InFilter.getInstance(this, fieldId, valueId));
    return this;
  }
  ...
  public class SqlFunction {
    ...
    private ExpressionBuilder[] getParams() {
      return this.params.toArray(new ExpressionBuilder[this.params.size()]);
    }

    // add params

    public SqlFunction addFieldParam(String fieldId) {
      this.params.add(new Field(fieldId));
      return this;
    }
    ...
    public SqlFunction _addValueParam(String valueId) {
      this.params.add(new Value(valueId));
      return this;
    }
    ...
    public SqlFunction addConstParam(String valueId, Object value) {
      this.params.add(new Constant(valueId, value));
      return this;
    }
    ...
    public FilterHelper eqField(String fieldId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getFieldEqualInstance(FilterHelper.this, fieldId, this.name,
          getParams()));
    ...
    public FilterHelper _eqValue(String valueId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getValueEqualInstance(FilterHelper.this, valueId, this.name,
          getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper eqConst(String valueId, Object value) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getConstantEqualInstance(FilterHelper.this, valueId, value,
          this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper gtField(String fieldId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getFieldGreaterThanInstance(FilterHelper.this, fieldId,
          this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper _gtValue(String valueId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getValueGreaterThanInstance(FilterHelper.this, valueId,
          this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper gtConst(String valueId, Object value) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getConstantGreaterThanInstance(FilterHelper.this, valueId,
          value, this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper ltField(String fieldId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getFieldLowerThanInstance(FilterHelper.this, fieldId,
          this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper _ltValue(String valueId) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getValueLowerThanInstance(FilterHelper.this, valueId,
          this.name, getParams()));
      return FilterHelper.this;
    }
    ...
    public FilterHelper ltConst(String valueId, Object value) {
      FilterHelper.this.list.addFilter(SqlFunctionFilter.getConstantLowerThanInstance(FilterHelper.this, valueId,
          value, this.name, getParams()));
      return FilterHelper.this;
    }
  }
