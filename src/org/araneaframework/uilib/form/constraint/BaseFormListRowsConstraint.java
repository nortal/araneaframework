 ...
 * @since 2.0
 */
public abstract class BaseFormListRowsConstraint<K, R> extends BaseConstraint {

  private final BaseFormListWidget<K, R> formList;

  public BaseFormListRowsConstraint(BaseFormListWidget<K, R> formList) {
