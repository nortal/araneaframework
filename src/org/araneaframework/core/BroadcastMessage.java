...
/**
 * {@link Message} that is sent to and operates on every {@link Component} in hierarchy.
...
public abstract class BroadcastMessage implements Message {
  ...
  /**
   * Method that is called on each {@link Component} present in the {@link Component} hierarchy
   * where this {@link BroadcastMessage} is propagated.
   * 
