...
/**
 * An <code>EventListener</code> that also allows multiple event parameters. Subclasses should
...
public abstract class MultiParamEventListener implements EventListener {
   ...
   * {@link #processEvent(String, String[], InputData)}.
   */
  ...
  /**
   * Event handling with a parameter array. The array is never <code>null</code>. All
   * implementations should handle each <code>eventId</code> separately.
   * 
   ...
   */
  public abstract void processEvent(String eventId, String[] eventParams, InputData input)
      throws Exception;
}
