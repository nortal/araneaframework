...
/**
 * Factory interface for building {@link Expression}s using
 * a {@link VariableResolver}.
 * 
 * @see Expression
 */
public interface ExpressionFactory extends Serializable {
	 ...
	 * @return built <code>Expression</code>.
	 */
	Expression buildExpression(Resolver resolver);
}
