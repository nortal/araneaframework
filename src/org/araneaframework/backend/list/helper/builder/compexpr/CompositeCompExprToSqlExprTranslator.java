...
public abstract class CompositeCompExprToSqlExprTranslator implements
		CompExprToSqlExprTranslator {

	public final SqlExpression translate(ComparatorExpression expr,
			CompExprToSqlExprBuilder builder) {
		ComparatorExpression[] children = ((CompositeComparatorExpression) expr)
				.getChildren();
