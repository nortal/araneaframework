...
public class SqlAscendingExpression implements SqlExpression {

  private SqlExpression expr;

  public SqlAscendingExpression(SqlExpression expr) {
  ...
  public String toSqlString() {
    ...
    sb.append(this.expr.toSqlString()).append(" ASC");
    return sb.toString();
  }
