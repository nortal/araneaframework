...
public class ImageFileImporter extends DefaultFileImporter {
	...
	static {
		...
		images.add("gfx/butt_delete2.gif");
		images.add("gfx/butt_delete3.gif");
		images.add("gfx/butt_add.gif");
		images.add("gfx/butt_add3.gif");
		images.add("gfx/butt_maximize.gif");
		images.add("gfx/butt_minimize.gif");
		images.add("gfx/butt_change2.gif");
		images.add("gfx/butt_change3.gif");
		images.add("gfx/butt_search.gif");
