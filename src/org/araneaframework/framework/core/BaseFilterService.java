 ...
 * <p>
 * The child is initilized with <code>getChildServiceEnvironment()</code> which by default returns
...
public class BaseFilterService extends BaseService implements FilterService{
  ...
  /**
   * Returns the Environment of this service by default. The child
   * is initilized with this method. Meant for overriding. 
   */
