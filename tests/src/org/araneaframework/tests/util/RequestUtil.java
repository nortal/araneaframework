...
public abstract class RequestUtil {
  ...
  /**
   * Request is considered SUBMITTED only when some HTML form inputs (namely transaction id) is present. Aranea Form
   * Elements are not updated (read from request) unless request is marked submitted.
   */
