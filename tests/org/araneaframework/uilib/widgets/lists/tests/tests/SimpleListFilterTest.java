...
import org.araneaframework.uilib.widgets.lists.structure.ListFilter;
import org.araneaframework.uilib.widgets.lists.structure.filter.column.SimpleColumnFilter;
import org.araneaframework.uilib.widgets.lists.structure.filter.composite.AndFilter;
...
public class SimpleListFilterTest extends TestCase {
	...
	public void testListFilterBuilder() throws ExpressionEvaluationException {
		// build filter
		ListFilter filter = new AndFilter().add(
				new SimpleColumnFilter.Equals("name")).add(
				new SimpleColumnFilter.GreaterThanOrEquals("name")).add(
